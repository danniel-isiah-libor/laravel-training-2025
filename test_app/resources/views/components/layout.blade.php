            ...
            <nav class="bg-gray-800">
                ...
                <div class="flex h-16 items-center justify-between">
                    ...
                    <div class="hidden md:block">
                        ...
                        <a href="{{ route('admin.dashboard') }}" aria-current="page" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white {{ Route::currentRouteName() === 'admin.dashboard' ? "rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" : ''}}">Dashboard</a>
                        <a href="{{ route('interests.create')}}" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white {{ Route::currentRouteName() === 'interests.create' ? "rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" : ''}}">Interests</a>
                        <a href="{{ route('posts.index')}}" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white {{ Route::currentRouteName() === 'posts.index' ? "rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" : ''}}">Posts</a>
                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        <div>
                            ...
                            <!-- Profile dropdown -->
                            <div class="relative ml-3" id="dropdown">
                                <button id="dropdown-button" class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                                    <span class="absolute -inset-1.5"></span>
                                ...
                                <div id="dropdown-menu" class="absolute right-0 z-50 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 hidden transition duration-150 ease-in-out">
                            ...
                            <button id="dropdown-menu" class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                                <span class="absolute -inset-1.5"></span>
                                <span class="sr-only">Open user menu</span>
                        ...
                        @auth
                        <div>
                            <a href="{{ route('posts.index') }}" class="rounded-md bg-indigo-600 px-6 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign Up</a>
                            <a href="{{ route('posts.index') }}" class="rounded-md bg-indigo-600 px-6 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign In</a>
                        </div>
                        @endauth
                    </div>
                    </div>
